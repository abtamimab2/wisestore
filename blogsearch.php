    ...
    <div class="breadcrumb-section breadcrumb-bg-color--golden">
        <div class="breadcrumb-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="breadcrumb-title"><i class="fa fa-search-plus"></i> <?= $keyword ?> ( <?php echo $conn->query("SELECT COUNT(*) FROM posts WHERE title like '%$keyword%'")->fetch_array()[0]; ?> )</h3>
                        <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a href="index.html">Home</a></li>
                                    <li class="active" aria-current="page">post search</li>
                                </ul>
                            </nav>
                        </div>
                         <!-------------------------------- START OF SEARCHBAR ------------------------>
                         <section class="search__bar">
                            <form action="#" method="get" class="container search__bar-container">
                                <div>
